...
export function SportTemplates({
  ...
  return (
    <section className="sport-record-view sport-templates-view" aria-label="Szablony treningów">
      ...
      <div className="sport-record-view__intro"><div><p>Powtarzalne definicje treningów. Zawartość jest widoczna od razu, bez otwierania edycji.</p></div><Button variant="primary" leadingIcon={<Plus size={14} />} onClick={() => setCreating(true)}>Dodaj szablon</Button></div>
