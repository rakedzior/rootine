...
- Direction: Jeden zwarty bilans dnia z liczbą pozostałych elementów, a pod nim gęsty rejestr poziomych wierszy. Liczba „pozostało” jest typograficznie drugorzędna. Aktywne moduły są pierwsze, puste są neutralne, a ukończone automatycznie trafiają na dół i są mocno wygaszone, z jedynie śladowym seledynowym sygnałem wykonania. Kolor służy tylko postępowi, ostrzeżeniom i potwierdzeniu ukończenia.
- Memorable moment: Pierwsza liczba odpowiada dokładnie na pytanie „ile jeszcze zostało?”, a kolejność listy sama usuwa zakończone obszary z pola uwagi.
