...
- Direction: Jeden zwarty bilans dnia zaczyna się od kolejki najbliższych zaplanowanych pozycji, a obok pokazuje pojedynczy wskaźnik postępu i osobny licznik obszarów wymagających reakcji. Pod nim gęsty rejestr poziomych wierszy z tytułem jako kotwicą, opisem drugorzędnym i podpisaną kolumną stanu / postępu. Moduły zawsze zachowują kolejność preferencji użytkownika; puste są neutralne, a ukończone pozostają na swoim miejscu z pełną wysokością i stabilnym kontrastem oraz pojedynczym seledynowym sygnałem wykonania. Kolor służy tylko interakcjom, postępowi, ostrzeżeniom i potwierdzeniu ukończenia.
