...
Job: wybierz dzień, dodaj lub popraw produkt we właściwym posiłku, sprawdź kalorie, makroskładniki i nawodnienie, zamknij gotowy dzień, a w ustawieniach wylicz albo wpisz własne cele bez opuszczania dziennika.
...
Constraints: wpisy, cele, profil kalkulatora, strategia makroskładników, stan zamknięcia dnia i pomiary masy są zapisywane lokalnie; katalog zewnętrzny jest wyłącznie odczytywany przez lokalny proxy. Zamknięcie jest dostępne tylko dla bieżących i przeszłych dat, można je cofnąć, a każda późniejsza zmiana posiłku lub nawodnienia automatycznie otwiera dzień ponownie. Dla jednej daty istnieje jeden pomiar masy, a ponowny zapis świadomie go aktualizuje. Produkty podstawowe pochodzą z USDA Foundation Foods (CC0), a produkty rynkowe z Open Food Facts (ODbL). Kalkulatory są orientacyjnymi estymacjami dla dorosłych, nie diagnozą ani poradą medyczną; wynik zawsze pozostaje edytowalny, a ograniczenia są widoczne. Aplikacja musi działać ręcznie przy braku sieci. Bez kont i synchronizacji. Uszkodzony zapis nigdy nie jest nadpisywany bez świadomej decyzji użytkownika.
