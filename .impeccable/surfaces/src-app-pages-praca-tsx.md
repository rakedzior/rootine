...
- Direction: a two-navigation-layer personal workspace in Routine's graphite workshop system. Overview is the default main screen. The local rail is a collapsible company → project tree; selecting a project opens its task outline directly in the canvas.
