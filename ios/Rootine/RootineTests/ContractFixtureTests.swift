...
final class ContractFixtureTests: XCTestCase {
    ...
    func testS06TabAndModuleCatalogPreservesEveryRouteAndAffairsIdentifier() {
        ...
        XCTAssertEqual(MoreModule.affairs.hubTitle, "Pozostałe")
        XCTAssertEqual(MoreModule.affairs.title, "Pozostałe")
    }
    ...
    func testS05AffairsProjectionKeepsCompletedAndHidesAmountsFromCollapsedDescription() {
        ...
        XCTAssertEqual(MoreModule.affairs.rawValue, "affairs"); XCTAssertEqual(MoreModule.affairs.title, "Pozostałe")
    }
    ...
    func testMoreCatalogKeepsAllSevenRoutesAndHubLabels() {
        ...
        XCTAssertEqual(MoreModule.allCases.map(\.hubTitle), ["Notatki", "Sport", "Cele", "Praca", "Podróże", "Zdrowie", "Pozostałe"])
        XCTAssertEqual(MoreModule.affairs.title, "Pozostałe", "The module and hub use the same approved title")
