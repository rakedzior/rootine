...
- Pozostałe są centrum prywatnych zobowiązań: łączą sprawy w trzech horyzontach czasu, wspólny rejestr płatności jednorazowych, cyklicznych i subskrypcji, ważność dokumentów oraz rejestr pojazdów z terminami datowymi i przebiegowymi. Wspólny radar porządkuje najbliższe ryzyka między tymi rejestrami. Osobny moduł budżetu nie należy obecnie do zakresu produktu.
